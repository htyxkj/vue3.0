<template>
    <div>
        <el-input ref="input" v-model="model1" size="small" :clearable="clearable" :disabled="disabled" @change="dataChange" @blur="lostFocus" @focus="iconFocused">
            <i slot="suffix" class="el-input__icon el-icon-search" @click="iconClick()" :disabled="disabled>0" ></i>
        </el-input>
        <template v-if="dia">
