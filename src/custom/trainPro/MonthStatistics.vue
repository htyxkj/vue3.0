        ...
        <el-scrollbar style="height:600px" >
            ...
            <el-row style="padding-top:5px">
                <el-form @submit.native.prevent label-position="right" label-width="110px">
                    <div v-for="(cel,index) in tj_cell.ccells.cels" :key="index">
...
export default class YearStatistics extends Vue{
    ...
    async　selData(){
        ...
        if(!bok)
            return ;
        let btn1 = new BipMenuBtn("DLG"," 月统计")
        btn1.setDlgType("D")
        btn1.setDlgCont("trainPro.serv.TrainingStatisticsServ*201;0;0");//修复
