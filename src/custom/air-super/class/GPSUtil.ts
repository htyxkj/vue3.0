export namespace GPSUtil {
    ...
    class GPSUtil {
         ...
         * @return 
         */  
        gps84_To_Gcj02(lat:any,lon:any) {  
            if (this.outOfChina(lat, lon)) {  
                return [lat,lon];
            }  
            var dLat = this.transformLat(lon - 105.0, lat - 35.0);  
         ...
         * @return 
         */  
        gps84_To_bd09(lat:any,lon:any){  
            var gcj02 = this.gps84_To_Gcj02(lat,lon);  
            var bd09 = this.gcj02_To_Bd09(gcj02[0],gcj02[1]);  
            return bd09;  
        }  
        bd09_To_gps84(lat:any,lon:any){  
            var gcj02:any = this.bd09_To_Gcj02(lat, lon);  
