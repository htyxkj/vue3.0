            ...
            <el-main style="padding:0px">
                    ...
                    <div v-loading="valueTableLoading" :style="'height:'+tableHeight+'px'">
                        <table class="tableTitle">
                            <tr>
                                ...
                                <th style="text-align: right">单位产量发生额(当期)元</th>
                                <th style="text-align: right">月度发生额</th>
                                <th style="text-align: right">单位产量发生额(月度)元</th>
                                <th style="text-align: right">年度发生额</th>
                                <th style="text-align: right">单位产量发生额(年度)元</th>
                            </tr>
                        </table>
                    </div>
                </template>
                <template v-else>
                    <vxe-table resizable size="mini" class="mytable-scrollbar" ref="FIncomeTable" auto-resize highlight-current-row
                        ...
                        <vxe-table-column field="tmonth_output_rate" title="单位产量发生额(当期)元" align="right"></vxe-table-column>
                        ...
                        <vxe-table-column field="month_output_rate" title="单位产量发生额(月度)元" align="right"></vxe-table-column>
                        <vxe-table-column field="year_money" title="年度发生额" align="right">
                            <template v-slot="{row}"> 
                                {{getFormatValue(row.year_money)}}
                            </template>
                        </vxe-table-column>
                        <vxe-table-column field="year_money_rate" title="单位产量发生额(年度)元" align="right"></vxe-table-column>
