                        ...
                        <el-container>
                            <el-main>
                                <el-row>
                                    ...
                                    <bip-comm-editor v-if="celsAll[48]"  :cell="celsAll[48]" :cds="cell" :row="cell.index" />
                                </el-row>
                            </el-main>
                        </el-container>
                    </template>
                    ...
                    <template>
                        <el-container style="border: 0.5px solid #EBEEF5;">
                            ...
                            <el-main style="border-left: 0.5px solid #EBEEF5;padding:0px;">
                                ...
                                <el-row class="nt-rowStyle"> 
                                    <!-- 软件问题 -->
                                    <bip-comm-editor v-if="celsAll[29]" :cell="celsAll[29]"  :cds="cell" :row="cell.index" />
                                    </el-row>
                                <el-row class="nt-rowStyle"> 
                                    <!-- 元器件问题 -->
                                    <bip-comm-editor v-if="celsAll[31]" :cell="celsAll[31]"  :cds="cell" :row="cell.index" />
                                    </el-row>
                        ...
                        <el-container>
                            <el-main>
                                <el-row>
                                    ...
                                    <!-- 问题发生环节 -->
                                    <bip-comm-editor v-if="celsAll[35]" :cell="celsAll[35]"  :cds="cell" :row="cell.index" />
                                </el-row>
                            </el-main>
                        </el-container>
                    </template>
                            ...
                            <el-container>
                                ...
                                <el-main>
                                    <el-row>
                                        ...
                                        <!-- 问题处理方式 -->
                                        <bip-comm-editor v-if="celsAll[39]" :cell="celsAll[39]"  :cds="cell" :row="cell.index" />
                                        <!-- 编辑人 -->
                                        <bip-comm-editor v-if="celsAll[41]"  :cell="celsAll[41]" :cds="cell" :row="cell.index" /> 
                                        <!-- 编辑时间 -->
                                        <bip-comm-editor v-if="celsAll[42]"  :cell="celsAll[42]" :cds="cell" :row="cell.index" />
                                    </el-row>
                                </el-main>
                            </el-container>
                    </template>
...
/* 质量问题数据库 */
export default class QualityProblemDatabase extends Vue {
    ...
    async created(){
        ...
        this.cellId = "P30015";             //this.params.cellid;
